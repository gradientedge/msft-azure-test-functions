...
```text
@azure-test/otel-esbuild-esm@1.0.0 /Users/kamil/repo/ge/azure-test/functions/otel-esbuild-esm-dynamic-kv4_8
...
|---|---|
| http | 0.157242 |
| http-with-keyvault | 0.652038 |
| http-external-api | 1.329537 |
...
We see more traces but still missing gaps for `dns`, `interal` and additional instrumentation like `fs`.
